...
public final class BTraceRuntime  {
	...
	private static Object internalUnsafeObj = null;
	private static boolean isNewUnsafe = false;
	private static jdk.internal.misc.Unsafe theInternalUnsafe = jdk.internal.misc.Unsafe.getUnsafe();
...
//				internalUnsafeObj = theInternalUnsafe.get(null);
//				Class<?> internalUnsafeClass = internalUnsafeObj.getClass();
//				defineClassMethod = internalUnsafeClass.getMethod("defineClass", String.class,byte[].class,int.class,int.class,ClassLoader.class,ProtectionDomain.class);
//				isNewUnsafe = true;
//			} catch (Exception e) {
//				e.printStackTrace();
//				isNewUnsafe = false;
//			}
	...
	private static boolean isCaller(String str){
        StackTraceElement[] stackTrace = Thread.currentThread().getStackTrace();
        for (StackTraceElement e : stackTrace) {
//            System.out.println(e.getClassName() + "\t"
//                    + e.getMethodName() + "\t" + e.getLineNumber());
            if(e.getClassName().startsWith(str)){
                return true;
            }
        }
        return false;
    ...
    public static void init(PerfReader perfRead) {
		...
		if(!isCaller("com.sun.btrace.agent.Client")){
    ...
    /**
     * @see com.sun.btrace.BTraceUtils#instanceOf(java.lang.Object, java.lang.String)
     */
    ...
    static void println(String str) {
        BTraceRuntime br = getCurrent();
        br.send(str + LINE_SEPARATOR);
    }
...
//            new GetPropertyAction(name));
    ...
    /**
     * @see com.sun.btrace.BTraceUtils.Profiling#newProfiler()
     */
    ...
    /**
     * @see com.sun.btrace.BTraceUtils.Profiling#newProfiler(int)
     */
    ...
    /**
     * @see com.sun.btrace.BTraceUtils.Profiling#recordEntry(com.sun.btrace.Profiler, java.lang.String)
     */
    ...
    /**
     * @see com.sun.btrace.BTraceUtils.Profiling#recordExit(com.sun.btrace.Profiler, java.lang.String, long)
     */
    ...
    /**
     * @see com.sun.btrace.BTraceUtils.Profiling#snapshot(com.sun.btrace.Profiler)
     */
    ...
    /**
     * @see com.sun.btrace.BTraceUtils.Profiling#snapshotAndReset(com.sun.btrace.Profiler)
     */
...
//		if(isNewUnsafe){
			try{
//				ccc = (Class)defineClassMethod.invoke(internalUnsafeObj, className, code, 0, code.length, loader, null);
                ccc = theInternalUnsafe.defineClass(className, code, 0, code.length, loader, null);
			}catch(Exception e){
				BTraceUtils.println(e);
			}
//		} else {
//			ccc = unsafe.defineClass(className, code, 0, code.length, loader, null);
//		}
		unsafe.ensureClassInitialized(ccc);
        return ccc;
    }
